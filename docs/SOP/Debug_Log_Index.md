...
R7 採樣升級：
  ...
  - R7-3.9 C1 accurate reflection bake 已新增 accuracy_over_speed surface spec、1000SPP C1 visible-direction reflection package、runtime loader、preview test；目前完成 C1 reference proof，完整多視角反射仍需擴大 surface-direction coverage；讀 `Debug_Log.md` 的 `R7-3.9-c1-accurate-reflection-bake`
```
