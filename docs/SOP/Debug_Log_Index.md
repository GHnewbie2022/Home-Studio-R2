...
R7 採樣升級：
  ...
  - R7-3.10 south wall window rim fix 已加入：南牆窗洞 invalid region 內縮 6cm，正式 south wall 1024/1000spp package 已重烘，烘焙按鈕開啟時維持黑灰底加發光；讀 `Debug_Log.md` 的 `R7-3.10-south-wall-window-rim-and-bake-button-style-fix`。
