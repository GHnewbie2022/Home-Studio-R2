...
assert(js.includes('r7-3-quick-preview-fill-v3al'), 'JS shader cache token must identify latest R7 experiment version');
assert(html.includes('Home_Studio.js?v=r7-3-quick-preview-fill-v3al'), 'HTML must cache-bust JS for latest R7 experiment version');
