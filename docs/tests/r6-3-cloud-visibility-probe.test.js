...
assert(js.includes('r7-1-blue-noise-sampling-v1'), 'shader cache-bust token must identify latest R7-1 experiment version');
...
assert(html.includes('Home_Studio.js?v=r7-1-blue-noise-sampling-v1'), 'HTML must cache-bust Home_Studio.js for latest R7-1 experiment version');
