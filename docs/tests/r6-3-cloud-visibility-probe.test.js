...
assert(js.includes('r7-3-quick-preview-fill-v3al'), 'shader cache-bust token must identify latest R7 experiment version');
...
assert(html.includes('Home_Studio.js?v=r7-3-quick-preview-fill-v3al'), 'HTML must cache-bust Home_Studio.js for latest R7 experiment version');
