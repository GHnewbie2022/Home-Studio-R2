...
assert(html.includes('Home_Studio.js?v=r7-1-blue-noise-sampling-v2'), 'HTML must cache-bust Home_Studio for R7-1');
assert(homeStudio.includes('Home_Studio_Fragment.glsl?v=r7-1-blue-noise-sampling-v2'), 'Home_Studio shader cache token must identify R7-1 blue noise sampling');
