...
assert(html.includes('InitCommon.js?v=r7-1-blue-noise-sampling-v5'), 'HTML must cache-bust InitCommon for R7-1');
assert(html.includes('Home_Studio.js?v=r7-1-blue-noise-sampling-v5'), 'HTML must cache-bust Home_Studio for R7-1');
assert(homeStudio.includes('Home_Studio_Fragment.glsl?v=r7-1-blue-noise-sampling-v5'), 'Home_Studio shader cache token must identify R7-1 blue noise sampling');
