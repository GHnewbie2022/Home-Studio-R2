...
assert.doesNotMatch(html, /id="r739-sprout-ab-actions"|id="btn-r739-ab-a"|id="btn-r739-ab-b"|id="btn-r739-ab-c"|id="btn-r739-ab-d"/);
assert.doesNotMatch(homeStudio, /bindR739SproutABControls|refreshR739SproutABButtons/);
